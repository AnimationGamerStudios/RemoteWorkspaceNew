...
public class CopiumCrystalOreBlockBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:copium_crystal_ore_block")
	public static final Block block = null;

	public CopiumCrystalOreBlockBlock(LifeStatuesModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("copium_crystal_ore_block");
		}
