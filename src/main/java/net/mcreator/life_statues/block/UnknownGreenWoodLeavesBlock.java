...
public class UnknownGreenWoodLeavesBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:unknown_green_wood_leaves")
	public static final Block block = null;

	public UnknownGreenWoodLeavesBlock(LifeStatuesModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("unknown_green_wood_leaves");
		}
