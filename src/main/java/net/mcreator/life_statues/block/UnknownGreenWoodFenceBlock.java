...
public class UnknownGreenWoodFenceBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:unknown_green_wood_fence")
	public static final Block block = null;

	public UnknownGreenWoodFenceBlock(LifeStatuesModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("unknown_green_wood_fence");
		}
