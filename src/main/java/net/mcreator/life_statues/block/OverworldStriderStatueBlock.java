...
import net.mcreator.life_statues.procedures.OverworldStriderStatueOnBlockRightClickedProcedure;
...
public class OverworldStriderStatueBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:overworld_strider_statue")
	public static final Block block = null;

	public OverworldStriderStatueBlock(LifeStatuesModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("overworld_strider_statue");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			OverworldStriderStatueOnBlockRightClickedProcedure.executeProcedure(Stream
