...
public class UnknownGreenWoodWoodBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:unknown_green_wood_wood")
	public static final Block block = null;

	public UnknownGreenWoodWoodBlock(LifeStatuesModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("unknown_green_wood_wood");
		}
