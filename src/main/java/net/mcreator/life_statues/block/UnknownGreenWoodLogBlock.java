...
public class UnknownGreenWoodLogBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:unknown_green_wood_log")
	public static final Block block = null;

	public UnknownGreenWoodLogBlock(LifeStatuesModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("unknown_green_wood_log");
		}
