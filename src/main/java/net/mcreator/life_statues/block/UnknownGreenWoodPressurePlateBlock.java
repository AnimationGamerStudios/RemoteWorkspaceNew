...
public class UnknownGreenWoodPressurePlateBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:unknown_green_wood_pressure_plate")
	public static final Block block = null;

	public UnknownGreenWoodPressurePlateBlock(LifeStatuesModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("unknown_green_wood_pressure_plate");
		}
