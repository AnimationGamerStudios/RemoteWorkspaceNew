...
public class CopiumBlockBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:copium_block")
	public static final Block block = null;

	public CopiumBlockBlock(LifeStatuesModElements instance) {
		super(instance, 6);
	}
