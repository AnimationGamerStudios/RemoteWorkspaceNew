...
public class StatueCustomizationWorkbenchBlock extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:statue_customization_workbench")
	public static final Block block = null;

	public StatueCustomizationWorkbenchBlock(LifeStatuesModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("statue_customization_workbench");
		}
