...
public class CopiumIngotItem extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:copium_ingot")
	public static final Item block = null;

	public CopiumIngotItem(LifeStatuesModElements instance) {
		super(instance, 4);
	}
