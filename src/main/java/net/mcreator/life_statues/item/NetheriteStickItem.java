...
public class NetheriteStickItem extends LifeStatuesModElements.ModElement {
	@ObjectHolder("life_statues:netherite_stick")
	public static final Item block = null;

	public NetheriteStickItem(LifeStatuesModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("netherite_stick");
		}
